...
/**
 *
 * @author SONGSONG Minion interrogation ====================
 *
 ...
 *
 * If you interrogate A first, then you expect to take 12.5 minutes. If you
 * interrogate B first, then you expect to take 13 minutes and thus must
 ...
 * optimal list.
 *
 * There will be at-least two and no more than 50 minions. All the integers in
 * the input will be positive integers, no more than 1024.
 *
 * Languages =========
 *
 ...
 * Test cases ==========
 *
 * Inputs: (int) minions = [[5, 1, 5], [10, 1, 2]] Output: (int list) [1, 0]
 *
 * Inputs: (int) minions = [[390, 185, 624], [686, 351, 947], [276, 1023, 1024],
 * [199, 148, 250]] Output: (int list) [2, 3, 0, 1]
 */
public class Minion_Interrogation {
    ...
    public static int[] answer(int[][] minions) {
        ...
        for (int i = 0; i < length; i++) {
            res[i] = i;
            weight[i] = (double) minions[i][0] * (double) minions[i][2] / (double) minions[i][1];
        }
        //sort by weight
        for (int i = 0; i < length; i++) {
    ...
    public static void main(String[] args) {
        int[][] m = {{390, 185, 624}, {686, 351, 947}, {276, 1023, 1024},
        {199, 148, 250}};
        int[] s = answer(m);
        for (int i : s) {
            System.out.print(i + " ");
